...
pcl::visualization::PCLVisualizer::Ptr viewer(new pcl::visualization::PCLVisualizer("All Cloud"));
pcl::visualization::PCLVisualizer::Ptr viewer2(new pcl::visualization::PCLVisualizer("Objects Only"));
...
//     }
    ...
    void PointCloudSegment::cityBlock(ros::NodeHandle nh,ProcessPointClouds<pcl::PointXYZ> *pointProcessorI, const pcl::PointCloud<pcl::PointXYZ>::Ptr &inputCloud)
    {
        // ----------------------------------------------------
    ...
    void PointCloudSegment::init()
    {
        ...
        while (ros::ok())
        {
            ...
            cityBlock(nodeHandle_,pointProcessorI, inputCloudI); //障碍物检测
            ros::spinOnce();
        }
    }
